...
public class GanttChartSample extends Application {
    ...
    @Override public void start(Stage stage) {
        ...
        chart.setBlockHeight( 5);
        String machine;

        machine = machines[0];
        XYChart.Series series1 = new XYChart.Series();
        series1.getData().add(new XYChart.Data(10, machine, new ExtraData( 2, "status-red")));
        ...
        series1.getData().add(new XYChart.Data(2, machine, new ExtraData( 3, "status-green")));
